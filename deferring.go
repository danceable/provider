...
func (c *deferring) Resolve(abstraction any, opts ...ResolveOption) error {
...
func (c *deferring) Call(receiver any, opts ...ResolveOption) error {
...
func (c *deferring) Fill(receiver any, opts ...ResolveOption) error {
